...
CLIENT_ID = '9V5mrAQyleSHZw'
CLIENT_SECRET = 'pRjdSYjTsptnWoDM0RVlwSk38tY'
...
def authorized():
    ...
    imageurl = r.upload_image('me_irl','./images/test.png')
    text = 'You are %s and have %u link karma.\nThe image was uploaded to %s' % (user.name,
                                               user.link_karma,imageurl)
    back_link = "<a href='/'>Try again</a>"
    return variables_text + '</br></br>' + text + '</br></br>' + back_link

if __name__ == '__main__':
    r = praw.Reddit('yeahboiii')
